...
const RecipeApp = () => {
  ...
  const text = [
    ...
    '2. У магічному колі додайте 2 гр Блакитного Місячного Пилу. Намагайтеся зберегти його ніжну синю кольорову силу.',
    '3. Обережно влийте 1 гр Вогняного Драконового Соку. Спостерігайте, як він додає різкість та енергію до зілля.',
    '4. Потім додайте 3 гр Золотої Сонячної Роси, даруючи зіллю світлу та теплу ауру.',
